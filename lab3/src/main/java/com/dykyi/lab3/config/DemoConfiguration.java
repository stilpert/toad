package com.dykyi.lab3.config;

import com.dykyi.lab3.study.entity.Address;
...
import com.dykyi.lab3.study.service.CourseService;
import com.dykyi.lab3.study.service.CuratorService;
import com.dykyi.lab3.automotive.service.OwnerService;
import com.dykyi.lab3.study.service.StudentService;
import com.dykyi.lab3.study.service.TeacherService;
    ...
    public CommandLineRunner loadCars(CarService carService, OwnerService ownerService, CarPartService carPartService) {
        return args -> {
            if (carService.getAll().isEmpty()) {
                ...
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Engine", car1));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Wheel", car1));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Battery", car2));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Brake", car2));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Transmission", car3));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Suspension", car4));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Radiator", car5));
                carPartService.save(new com.dykyi.lab3.automotive.entity.CarPart("Alternator", car6));
            }
        };
    }
}
